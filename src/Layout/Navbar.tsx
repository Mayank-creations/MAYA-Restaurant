...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      style={{
        background:
          'linear-gradient(to bottom, rgba(10,8,5,0.95), transparent)',
      }}
    >
      {/* Main Row */}
      <div className="flex items-center justify-between">
        ...
        <div className="text-center">
          <p className="font-serif text-xl font-light tracking-widest gold-text">
            MAYA
          </p>
          <p className="text-xs tracking-widest opacity-30 text-center">
            Omakase by MAYANK
          </p>
        </div>
